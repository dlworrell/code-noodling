...
- (Optional) PhysX Visual Debugger (PVD)
...
Tesla K80 users:
    CUDA architecture defaults to sm_37.
...
Generates all primes ≤ 50M using up to 4 Tesla K80 GPUs, writing them to primes_50M.json.
...
Donovan Worrell
Seattle, WA, USA
Email: donovan.worrell@gmail.com
